...
alias stream="open -a 'socialstream' && open -a 'OBS' --args --disable-shutdown-check --disable-updater --disable-missing-files-check --profile 'Gaming 2K' --collection 'Gaming 2K' && cd ~/Code/personal/liveshed && bin/setup"
...
alias record="open -a 'OBS' --args --disable-shutdown-check --disable-updater --disable-missing-files-check --profile 'Gaming 2K' --collection 'Gaming 2K'"
